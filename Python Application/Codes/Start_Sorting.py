...
class Sorting:
    def __init__(self, root, AlgoNameVar):
        ...
        self.information = {'Bubble Sort': "Worst Case:O(n²)\nAverage Case:O(n²)\nBest Case:O(n)",
                            'Comb Sort': "Worst Case:O(n²)\nAverage Case:O(n²/2^p)\nBest Case:O(n*log n)",
                            'Cocktail Shaker Sort': "Worst Case:O(n²)\nAverage Case:O(n²)\nBest Case:O(n)",
        ...
        self.algo_link = {'Bubble Sort': "https://en.wikipedia.org/wiki/Bubble_sort",
...
#         self.color_drawing.place(relx=0.5, rely=0)
        ...
        self.scale_size = Scale(self.frame1, label="Size :", orient=HORIZONTAL, from_=10, to=500, length=230,
        ...
        self.scale_speed = Scale(self.frame1, label="Speed :", orient=HORIZONTAL, from_=1, to=2000, length=230,
        ...
        self.label_comparison.place(relx=0.1, rely=0.60)
        ...
        self.frame_algo_info.place(relx=0.03, rely=0.65)
        ...
        # Button for wikipedia info
        self.inf_button = Button(self.frame1, bg="burlywood1", fg="RoyalBlue4", text="Go to the Wikipedia Page", command=self.link_button, cursor="hand2")
        self.inf_button.grid_propagate(0)
        self.inf_button.place(relx=0.2, rely=0.88)
        ...
        for num in self.numbers:
            self.canva.create_rectangle(self.starting_point, self.CANVAS_Y - num, self.starting_point + self.rec_width, self.CANVAS_Y, fill="gold")
    ...
    def new_list(self):
        ...
        # if bar graph is selected
        if self.TYPE == 0:
            colortype = ["gold" for x in self.numbers]
        # if color graph is selected
        else:
    ...
    def case_chooser(self, event):
        ...
        links = self.algo_link[self.algo_var.get()]
        self.inf_button.bind("<Button>",lambda e:self.callback(links))

    # function for choosing binding the button with wikipedia link
