...
class Searching:
    def __init__(self, root, AlgoNameVar):
        ...
        self.information = {'Linear Search': "Worst Case:O(n)\nAvg Case:O(n/2)\nBest Case:O(1)",
                            ...
                            'Jump Search':"Worst Case:O(sqrt(n))\nAvg Case:O(sqrt(n))\nBest Case:O(1)"}

        self.algo_link = {'Linear Search': "https://en.wikipedia.org/wiki/Linear_search",
    ...
    def case_chooser(self, event):
        ...
        self.inf_button.bind("<Button-1>",lambda e:self.callback(links))
