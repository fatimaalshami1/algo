...
// import {PrimeAlgorithm} from "../algorithms/prime";
// import Spiral from "./Spiral.jsx";

class PrimeAlgorithm extends Component {
    state = {
        number: 100,
        cells:[],
        isRunning:false,
    ...
    startAlgo = () =>{
        console.log(this.state.algo);
        if( this.state.algo === 0 ){
            this.startPrimeAlgorithm();
        }else if( this.state.algo === 1 ){
            this.startSpiral();
        }
    }
    startSpiral = async () =>{
        let pprimes = PrimeAlgorithm(this.state.number*100);
        let primes = [];
